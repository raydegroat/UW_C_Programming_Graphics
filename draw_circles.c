/* 	Raymond de Groat (c) 1995 raytech@u.washington.edu
	University of Washngton - C Programming, Graphics - Final prjoject
	This program will use my own primitives to draw num_circles from the top left to the bottom right of a window.
*/
...
void CGR_draw_line( CGR_line_p_t line)
{
	...
	if((line->end1.xco - line->end2.xco) * (line->end1.yco - line->end2.xco) >0) /*  Slope is positive. */
	{
...
{
	while(num_points--) 					c/* Thats better! */
